...
import { useFavorites } from "./FavoriteContext"; // Ajuste o caminho
...
export default function Home() {
  ...
  const carouselImages = [
    { id: "1", src: require("../screens/img/cachorropurple-convertido-de-png.png")},
    { id: "2", src: require("../screens/img/gatopurple.png") },
    { id: "3", src: require("../screens/img/cachorroblack-convertido-de-png.png") },
